...
| `QueueFake` | Guarda pushes admitidos, su identidad de dispatch serializada, prioridad efectiva y tags normalizados mientras reproduce deduplicacion local; usa `assertPushed()`, `size()` y `clear()`. |
