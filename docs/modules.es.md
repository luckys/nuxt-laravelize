...
| `QueueFake` | Guarda pushes admitidos y chains preparadas completas, incluida identidad de dispatch, prioridad efectiva y tags normalizados; usa `pushed`, `chains`, `assertPushed()`, `size()` y `clear()`. |
