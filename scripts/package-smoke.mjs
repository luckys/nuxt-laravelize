...
runFixture('features', {
  ...
  requiredExports: {
    ...
    '@nuxt-laravelize/scout-drizzle': ['DrizzlePostgresSearchEngine', 'scoutDocuments'],
    '@nuxt-laravelize/scout-drizzle/postgres': ['DrizzlePostgresSearchEngine'],
    '@nuxt-laravelize/scout-drizzle/sqlite': ['DrizzleSQLiteSearchEngine', 'sqliteScoutDocuments'],
    '@nuxt-laravelize/scout-drizzle/turso': ['TursoLibSQLSearchEngine'],
  ...
  try {
    ...
    if (options.buildNuxt) {
      ...
      writeFileSync(join(fixture, 'runtime-smoke.mjs'), [
        ...
        '  for (const service of [\'container\', \'cache\', \'cacheLock\', \'dispatcher\', \'encrypter\', \'filesystem\', \'hasher\', \'queue\', \'mailer\', \'notifications\', \'scout\', \'urlSigner\', \'rateLimiter\', \'validator\']) {',
