...
| `@nuxt-laravelize/database-queue` | Dispatch explicito best-effort a queue despues de confirmar un commit de base de datos |
...
| `@nuxt-laravelize/database-queue` | Raiz del paquete | - |
