...
export default defineNuxtConfig({
  modules: ['@nuxt-laravelize/notifications-webhook'],
})
```
...
[`@nuxt-laravelize/notifications`](../notifications/README.es.md), [`@nuxt-laravelize/webhooks`](../webhooks/README.es.md), [`@nuxt-laravelize/reliability`](../reliability/README.es.md).
