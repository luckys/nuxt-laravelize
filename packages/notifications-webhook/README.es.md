...
Entrega durable tenant-fenced mediante webhooks firmados

## Instalacion

```bash
pnpm add @luckys_luis/nuxt-laravelize-notifications-webhook @luckys_luis/nuxt-laravelize-notifications @luckys_luis/nuxt-laravelize-reliability @luckys_luis/nuxt-laravelize-webhooks
```

```ts
// nuxt.config.ts
export default defineNuxtConfig({
  modules: ['@luckys_luis/nuxt-laravelize-notifications-webhook'],
})
```
...
### Entrega una notificacion mediante webhook durable

Mantiene la ruta opaca y resuelve ownership del endpoint, URL y secret ID en el servidor. El payload no puede elegir destino ni clave de firma; el worker webhook separado resuelve el secret al entregar.
...
[`@luckys_luis/nuxt-laravelize-notifications`](../notifications/README.es.md), [`@luckys_luis/nuxt-laravelize-webhooks`](../webhooks/README.es.md), [`@luckys_luis/nuxt-laravelize-reliability`](../reliability/README.es.md).
