...
### Deliver a notification through a durable webhook

Keep the route opaque and resolve endpoint ownership, URL, and secret ID on the server. The notification payload cannot select a destination or signing key; the separate webhook worker resolves the secret at delivery time.
...
[`@luckys_luis/nuxt-laravelize-notifications`](../notifications/README.md), [`@luckys_luis/nuxt-laravelize-webhooks`](../webhooks/README.md), [`@luckys_luis/nuxt-laravelize-reliability`](../reliability/README.md).
