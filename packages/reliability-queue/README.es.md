...
```bash
pnpm add @nuxt-laravelize/reliability-queue @nuxt-laravelize/reliability @nuxt-laravelize/queue
```

```ts
// nuxt.config.ts
export default defineNuxtConfig({
  modules: ['@nuxt-laravelize/reliability-queue'],
})
```
...
[`@nuxt-laravelize/reliability`](../reliability/README.es.md), [`@nuxt-laravelize/queue`](../queue/README.es.md), [`@nuxt-laravelize/nuxt`](../nuxt/README.es.md).
