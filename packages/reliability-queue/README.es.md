...
Bridge Nuxt de mensajes Inbox/Outbox durables a jobs registrados

## Instalacion

```bash
pnpm add @luckys_luis/nuxt-laravelize-reliability-queue @luckys_luis/nuxt-laravelize-reliability @luckys_luis/nuxt-laravelize-queue
```

```ts
// nuxt.config.ts
export default defineNuxtConfig({
  modules: ['@luckys_luis/nuxt-laravelize-reliability-queue'],
})
```
...
### Conecta mensajes reliable con jobs registrados

El bridge Nuxt registra `ReliableMessageJob` y handlers reliable sin elegir un transporte de queue. Liga stores Inbox/Outbox durables e instala BullMQ u otro driver por separado para entrega de produccion.
...
[`@luckys_luis/nuxt-laravelize-reliability`](../reliability/README.es.md), [`@luckys_luis/nuxt-laravelize-queue`](../queue/README.es.md), [`@luckys_luis/nuxt-laravelize`](../nuxt/README.es.md).
