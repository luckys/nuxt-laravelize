...
Dispatch explicito best-effort a queue despues de confirmar un commit de base de datos
...
[`@luckys_luis/nuxt-laravelize-database`](../database/README.es.md), [`@luckys_luis/nuxt-laravelize-queue`](../queue/README.es.md), [`@luckys_luis/nuxt-laravelize-reliability`](../reliability/README.es.md).
