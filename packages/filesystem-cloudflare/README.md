...
Cloudflare R2 binding filesystem adapter for Nuxt Laravelize
...
### Use a Cloudflare R2 binding

The adapter accepts the structural R2 bucket contract and does not import Workers types or the AWS SDK. It supports byte operations, bounded paginated listing, and streaming; R2 bindings cannot sign temporary URLs or direct-upload forms.
...
[`@luckys_luis/nuxt-laravelize-filesystem`](../filesystem/README.md).
