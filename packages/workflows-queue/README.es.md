...
```bash
pnpm add @nuxt-laravelize/workflows-queue @nuxt-laravelize/workflows @nuxt-laravelize/queue
```
...
[`@nuxt-laravelize/workflows`](../workflows/README.es.md), [`@nuxt-laravelize/queue`](../queue/README.es.md).
