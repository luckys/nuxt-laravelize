...
```bash
pnpm add @nuxt-laravelize/agents-flue @nuxt-laravelize/agent-sdk @flue/runtime@1.0.0-beta.9 @flue/sdk@1.0.0-beta.9
```
...
```ts
import { FlueAgentRuntime } from '@nuxt-laravelize/agents-flue'
