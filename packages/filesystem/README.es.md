...
export default defineNuxtConfig({
  modules: ['@nuxt-laravelize/filesystem'],
})
```
...
[`@nuxt-laravelize/filesystem-aws`](../filesystem-aws/README.es.md), [`@nuxt-laravelize/filesystem-cloudflare`](../filesystem-cloudflare/README.es.md).
