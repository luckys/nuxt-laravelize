...
Discos portables, almacenamiento en memoria y adapter local Node confinado al root
...
export default defineNuxtConfig({
  modules: ['@luckys_luis/nuxt-laravelize-filesystem'],
})
```
...
[`@luckys_luis/nuxt-laravelize-filesystem-aws`](../filesystem-aws/README.es.md), [`@luckys_luis/nuxt-laravelize-filesystem-cloudflare`](../filesystem-cloudflare/README.es.md).
