...
Notificaciones realtime tenant-fenced mediante el broadcaster configurado
...
### Entrega una notificacion broadcast aislada por tenant

La notificacion solo elige tipo, version y datos acotados. La ruta del destinatario aporta el recipient y tenant opacos; el paquete deriva el canal privado y el nombre fijo del evento.
...
[`@luckys_luis/nuxt-laravelize-notifications`](../notifications/README.es.md), [`@luckys_luis/nuxt-laravelize-broadcasting-pusher`](../broadcasting-pusher/README.es.md).
