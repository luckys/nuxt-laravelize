...
```bash
pnpm add @nuxt-laravelize/notifications-broadcast
```

```ts
// nuxt.config.ts
export default defineNuxtConfig({
  modules: ['@nuxt-laravelize/notifications-broadcast'],
})
```
...
[`@nuxt-laravelize/notifications`](../notifications/README.md), [`@nuxt-laravelize/broadcasting-pusher`](../broadcasting-pusher/README.md).
