...
const namespace = 'nuxt-laravelize.scout-drizzle'
...
export const postgresMigrationSource: MigrationSource<'postgresql'> = defineSource(namespace, async () => [
  await loadMigration('postgresql', '0000_create_scout_documents', '0000_create_scout_documents.sql'),
])

export const sqliteMigrationSource: MigrationSource<'sqlite'> = defineSource(namespace, async () => [
  await loadMigration('sqlite', '0001_create_scout_documents_sqlite', '0001_create_scout_documents_sqlite.sql'),
])
