...
```bash
pnpm add @nuxt-laravelize/notifications-database-drizzle @nuxt-laravelize/notifications-database drizzle-orm
```
...
```ts
import { DrizzlePostgresDatabaseNotificationStore } from '@nuxt-laravelize/notifications-database-drizzle/postgres'
...
[`@nuxt-laravelize/notifications-database`](../notifications-database/README.es.md), [`@nuxt-laravelize/migrations-drizzle`](../migrations-drizzle/README.es.md).
