...
### Use the durable database-notification stores

Apply the PostgreSQL or SQLite migration and inject the matching store. Each operation derives the tenant scope from the trusted recipient and keeps duplicate content idempotent while rejecting conflicting reuse.
...
[`@luckys_luis/nuxt-laravelize-notifications-database`](../notifications-database/README.md), [`@luckys_luis/nuxt-laravelize-migrations-drizzle`](../migrations-drizzle/README.md).
