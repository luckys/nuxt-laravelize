...
Idempotencia HTTP con leases, conflictos de fingerprint y replay
...
export default defineNuxtConfig({
  modules: ['@luckys_luis/nuxt-laravelize-idempotency'],
})
```
...
[`@luckys_luis/nuxt-laravelize-idempotency-drizzle`](../idempotency-drizzle/README.es.md), [`@luckys_luis/nuxt-laravelize-http`](../http/README.es.md).
