...
export default defineNuxtConfig({
  modules: ['@nuxt-laravelize/notifications-queue'],
})
```
...
[`@nuxt-laravelize/notifications`](../notifications/README.es.md), [`@nuxt-laravelize/queue`](../queue/README.es.md), [`@nuxt-laravelize/reliability`](../reliability/README.es.md).
