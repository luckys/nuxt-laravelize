...
```bash
pnpm add @nuxt-laravelize/notifications-mail
```

```ts
// nuxt.config.ts
export default defineNuxtConfig({
  modules: ['@nuxt-laravelize/notifications-mail'],
})
```
...
[`@nuxt-laravelize/notifications`](../notifications/README.es.md), [`@nuxt-laravelize/mail`](../mail/README.es.md).
