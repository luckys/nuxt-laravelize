...
Schedules independientes del framework y adapter Nitro 3 explicito
...
| `./nitro3` | Entrypoint publico de este package. |
...
[`@luckys_luis/nuxt-laravelize-scheduler-nuxt`](../scheduler-nuxt/README.es.md), [`@luckys_luis/nuxt-laravelize-cache`](../cache/README.es.md).
