...
```bash
pnpm add @nuxt-laravelize/execution-context
```

```ts
// nuxt.config.ts
export default defineNuxtConfig({
  modules: ['@nuxt-laravelize/execution-context'],
})
```
...
```ts
import { useExecutionContext } from '@nuxt-laravelize/execution-context/runtime'
...
[`@nuxt-laravelize/execution-context-queue`](../execution-context-queue/README.es.md), [`@nuxt-laravelize/observability`](../observability/README.es.md), [`@nuxt-laravelize/audit`](../audit/README.es.md).
