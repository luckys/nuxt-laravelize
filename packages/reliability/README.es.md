...
```bash
pnpm add @nuxt-laravelize/reliability
```
...
[`@nuxt-laravelize/reliability-drizzle`](../reliability-drizzle/README.es.md), [`@nuxt-laravelize/reliability-queue`](../reliability-queue/README.es.md), [`@nuxt-laravelize/webhooks`](../webhooks/README.es.md).
