...
Canales, routing bajo demanda y eventos de lifecycle de entrega

## Instalacion

```bash
pnpm add @luckys_luis/nuxt-laravelize-notifications
```

```ts
// nuxt.config.ts
export default defineNuxtConfig({
  modules: ['@luckys_luis/nuxt-laravelize-notifications'],
})
```
...
[`@luckys_luis/nuxt-laravelize-notifications-mail`](../notifications-mail/README.es.md), [`@luckys_luis/nuxt-laravelize-notifications-database`](../notifications-database/README.es.md), [`@luckys_luis/nuxt-laravelize-notifications-queue`](../notifications-queue/README.es.md).
