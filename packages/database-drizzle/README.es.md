...
```bash
pnpm add @luckys_luis/nuxt-laravelize-database-drizzle drizzle-orm
```
...
[`@luckys_luis/nuxt-laravelize-database`](../database/README.es.md), [`@luckys_luis/nuxt-laravelize-reliability-drizzle`](../reliability-drizzle/README.es.md).
